...
class Ui_Dialog(object):
    ...
    def setupPayHistory(self, Dialog):
        ...
        self.payHistoryTable.setColumnWidth(3, self.payHistoryTable.width()*3/10)
    ...
    def cancelBtnClicked(self):
        remove_row = self.payListTable.selectedIndexes()
        self.payListTable.removeRow(remove_row[0].row())
